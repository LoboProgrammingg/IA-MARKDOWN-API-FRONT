...
class UserUpdateForm(forms.ModelForm):
    ...
    first_name = forms.CharField(label='Primeiro Nome', required=False, widget=forms.TextInput(attrs={'placeholder': 'Seu primeiro nome', **tailwind_input_classes}))
    last_name = forms.CharField(label='Sobrenome', required=False, widget=forms.TextInput(attrs={'placeholder': 'Seu sobrenome', **tailwind_input_classes}))
